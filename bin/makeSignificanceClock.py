            ...
            if os.path.exists(input_file):
                try:
                    ...
                    if event["timeTag"][0]>event["timeTag"][-1]:
                        duration = (event["timeTag"][-1]-event["timeTag"][0]+2**40)/1e8
                    else:
                        duration = (event["timeTag"][-1]-event["timeTag"][0])/1e8
                    ...
                    time = (event["timeTag"]-event["timeTag"][0])/1e8
                    time[time<-10]+=(2**40)/1e8
