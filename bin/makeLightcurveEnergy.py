...
if len(sys.argv)<2:
    print("Usage: makeQLspectrum.py <input file> <adc channel> <bin width (sec)> <lower energy (MeV)> <upper energy (MeV)>")
    exit()
...
unix_time = event["unixTime"][(energy>=threshold[0])&(energy<=threshold[1])]
